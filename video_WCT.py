...
parser.add_argument('--contentPath',default='test_images',help='path to train')
...
parser.add_argument('--output', default='/home/sam/Pictures/LDV2_test15_WCT/Viento/alpha0.6/001__.mp4', help='folder to output video')
...
def main(contentPath,stylePath,output,alpha,fps,cuda,gpu):
    ...
    with torch.no_grad():
        ...
        # 计算模型的参数量
        num_parameters = sum(p.numel() for p in wct.parameters())
...
if __name__ == "__main__":
    main(args.contentPath,args.stylePath,args.output,args.alpha,args.fps,args.cuda,args.gpu)